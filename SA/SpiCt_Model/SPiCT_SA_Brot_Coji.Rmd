...
plotspict.fb(resbro, ylim=c(0, 3), xlim=c(0, 100000))
...
plotspict.ffmsy(resbro2, qlegend=FALSE)
plotspict.catch(resbro2, qlegend=FALSE)
plotspict.fb(resbro2, man.legend=FALSE)
```
