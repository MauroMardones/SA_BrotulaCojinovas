...
```{r ,  fig.cap="Variables used in LBPA estimation model", fig.height=4, fig.width=4}
...
```{r fig.cap="Maturity and Selectivity at Length", fig.height=2, fig.width=3}
...
```{r echo=FALSE, fig.cap="Outputs of different relative Length estimated in LBPA", fig.height=2, fig.width=3 }
...
```{r  fig.height=2, fig.width=3, fig.cap="Yield and Spawning Biomass-per-recruit as a function of fishing mortality" }
ypr <- ggplot(data=YPR1, aes(x=YPR[,1]))+
   ...
   scale_y_continuous(breaks = seq(from = 0, to = 1, by = 0.1))+
   geom_text(x=2, y=0.7, label="F/F Target = 0.263")+
